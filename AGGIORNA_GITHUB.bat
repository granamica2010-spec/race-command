...
echo [2/4] Copio Race Command 1.7.3 nel repository...
...
if errorlevel 1 (
  git commit -m "Race Command v1.7.3 - aggiornamento automatico"
  if errorlevel 1 goto :FAIL
) else (
...
echo.
echo ============================================================
echo   FATTO: Race Command 1.7.3 e stato inviato su GitHub.
echo ============================================================
echo.
