...
echo [2/4] Copio Race Command 1.8 nel repository...
...
if errorlevel 1 (
  git commit -m "Race Command v1.8 - aggiornamento automatico"
  if errorlevel 1 goto :FAIL
) else (
...
echo.
echo ============================================================
echo   FATTO: Race Command 1.8 e stato inviato su GitHub.
echo ============================================================
echo.
