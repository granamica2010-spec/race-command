...
echo [2/4] Copio Race Command 2.0.0 nel repository...
...
if errorlevel 1 (
  git commit -m "Race Command v2.0.0 - aggiornamento automatico"
  if errorlevel 1 goto :FAIL
) else (
...
echo.
echo ============================================================
echo   FATTO: Race Command 2.0.0 e stato inviato su GitHub.
echo ============================================================
echo.
